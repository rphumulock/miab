...
import { LoggingService, LabelFocusDetector } from '../../../shared';


@Component({
    templateUrl: 'text.component.html',
    styleUrls: ['text.component.css'],
    providers: [LabelFocusDetector]
})
export class TestTextFrameComponent {
    ...
    imgFrameUrl: string;
    mainMessage: string;
    labelFocus: LabelFocusDetector;

    constructor(
        protected modalService: NgModalService,
        protected formBuilder: FormBuilder,
        protected logger: LoggingService,
        protected labelFocuser: LabelFocusDetector) {
